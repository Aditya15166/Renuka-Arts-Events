  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 border-b border-white/10 transition-all duration-300 ${
        isScrolled ? "bg-black/90 backdrop-blur-md" : "bg-black/0 backdrop-blur-xs"
      }`}
    >
          ...
          <nav className="hidden lg:flex items-center gap-2">
            ...
            <div className="relative" onMouseEnter={handleMouseEnterDropdown} onMouseLeave={handleMouseLeaveDropdown}>
              ...
              {showPortfolioDropdown && (
                <div className="absolute top-full left-0 mt-2 w-80 p-4 bg-black/95 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl animate-fade-in-down">
